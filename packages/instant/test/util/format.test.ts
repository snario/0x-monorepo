...
const ONE_ETH_IN_BASE_UNITS = EthRPCClient.toBaseUnitAmount(BIG_NUMBER_ONE, ethDecimals);
const DECIMAL_ETH_IN_BASE_UNITS = EthRPCClient.toBaseUnitAmount(BIG_NUMBER_DECIMAL, ethDecimals);
const IRRATIONAL_ETH_IN_BASE_UNITS = EthRPCClient.toBaseUnitAmount(BIG_NUMBER_IRRATIONAL, ethDecimals);
